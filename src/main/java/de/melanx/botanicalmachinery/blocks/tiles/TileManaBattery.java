...
public class TileManaBattery extends TileBase {
    ...
    public TileManaBattery() {
        super(BMConfig.SERVER.capacities.manaBattery);
    }
    ...
    public void writePacketNBT(NBTTagCompound cmp) {
        ...
        cmp.setBoolean(TileTags.SLOT_1_LOCKED, this.slot1Locked);
        cmp.setBoolean(TileTags.SLOT_2_LOCKED, this.slot2Locked);
    }
    ...
    public int getCurrentMana() {
        return ((BlockManaBattery) world.getBlockState(this.pos).getBlock()).variant == BlockManaBattery.Variant.CREATIVE ? this.getManaCap() / 2 : this.mana;
    }
        ...
        if (this.world != null && !this.world.isRemote) {
            ...
            if (!minus.isEmpty()) {
                if (minus.getItem() instanceof IManaItem) {
                    ...
                    int maxManaValue = ((BlockManaBattery) world.getBlockState(this.pos).getBlock()).variant == BlockManaBattery.Variant.NORMAL ? MANA_TRANSFER_RATE : Integer.MAX_VALUE;
            ...
            for (EnumFacing direction : EnumFacing.values()) {
                ...
                if (tile instanceof TileBase) {
                    ...
                    if (!offsetTile.isFull()) {
                        ...
                        this.recieveMana(-manaValue);
                        offsetTile.recieveMana(manaValue);
                        this.markDirty();
                        this.markDispatchable();
                    }
                }
