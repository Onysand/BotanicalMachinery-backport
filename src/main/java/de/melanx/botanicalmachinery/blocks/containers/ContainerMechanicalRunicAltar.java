...
public class ContainerMechanicalRunicAltar extends ContainerBase<TileMechanicalRunicAltar> {
    public ContainerMechanicalRunicAltar(World world, BlockPos pos, InventoryPlayer playerInventory, EntityPlayer player) {
        super(world, pos, playerInventory, player, 17, 33);
