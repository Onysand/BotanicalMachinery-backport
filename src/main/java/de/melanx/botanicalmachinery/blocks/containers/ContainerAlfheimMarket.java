...
public class ContainerAlfheimMarket extends ContainerBase<TileAlfheimMarket> {
    public ContainerAlfheimMarket(World world, BlockPos pos, InventoryPlayer playerInventory, EntityPlayer player) {
        super(world, pos, playerInventory, player, 4, 5);
        ...
        this.addSlotToContainer(new SlotOutputOnly(inventory, index, 125, 35));
